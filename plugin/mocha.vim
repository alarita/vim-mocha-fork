...
function! RunSpecs(spec)
  ...
  if g:spec_command ==? ""
    ...
    let l:spec = substitute(a:spec, "spec.ts", "spec.js", "g")
    let l:spec_command = substitute(g:spec_command, "{entry}", a:spec, "g")
    let l:spec_command = substitute(l:spec_command, "{spec}", l:spec, "g")
    " execute substitute(g:spec_command, "{spec}", l:spec, "g")
    execute l:spec_command
  end
endfunction
